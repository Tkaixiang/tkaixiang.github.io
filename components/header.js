        ...
        <div className="h-full" style={{ display: "flex", justifyContent: "center", alignItems: "center", overflowY: "auto" }}>
            ...
            <div style={{ position: "absolute", bottom: "20px" }} className="text-center w-full flex justify-center text-gray-800 ">
                {finishedOnce && (
                    ...
                    }} className={`${headerStyles.fadeIn} p-4 2xl:p-6 shadow-2xl cursor-pointer flex items-center flex-col rounded-lg text-gray-700 bg-gray-300 bg-opacity-30 hover:shadow-sm hover:opacity-50 transition-all duration-300`}>
