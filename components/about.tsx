...
import typescript from "../public/assets/typescript.webp";
  ...
  const mutationHandler = (entries, observer): void => {
    for (let i = 0; i < entries.length; i++) {
      if (
        ...
        progressList[entries[i].target.id][2].current === 0
      ) {
        setTimeout(() => {
          progressList[entries[i].target.id][1](
            progressConstants[entries[i].target.id],
          );
        }, 400);
      }
    }
    ...
    <div className="w-full h-full">
      ...
      <div className="flex mt-6 items-center lg:flex-row flex-col">
        ...
        <p className="text-gray-200 text-lg xl:text-xl">
          Hi there 😊! I am Teo Kai Xiang (otherwise known by my online names as{" "}
          <code>Tkai</code> or <code>Tkaixiang</code>). I enjoy tech stuff, and
          have been mainly focusing on <b>Web/App Development</b>, along with{" "}
          <b>AI/ML</b> &amp; <b>Cybersecurity</b>.
          <br />
          <br />
          You might see me take part in local <b>Hackathons</b>, <b>CTFs</b> and{" "}
          <b>Game jams</b>, do say hi if you do ✋! <br />
          You can find a list of stuff I have worked with below this, as well as
          a <b>Showcase</b> of projects I worked on further down the page.
        </p>
        <div className="ml-3 grid grid-cols-2  w-full mt-5 lg:mt-0 lg:w-20 lg:grid-cols-1 gap-4 ">
          <div
            className={`${AboutStyles.cardStyle}`}
            onClick={() => {
              openUrl("https://github.com/Tkaixiang");
            }}
          >
          ...
          <div
            className={AboutStyles.cardStyle}
            onClick={() => {
              openUrl("https://www.linkedin.com/in/teo-kai-xiang-3209a61b3/");
            }}
          >
            <div className="text-2xl">
              <svg
      ...
      <h2
        style={{ width: "fit-content" }}
        className="mt-2 text-3xl lg:text-4xl 2xl:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 to-green-500"
      >
        {" "}
        Proficiency &amp; Skills
      </h2>
      <div className="mt-7 grid lg:grid-cols-2 gap-4">
        <div id="line1" className="flex flex-col justify-center">
          <div className="mb-2 text-2xl font-bold flex items-baseline ">
            <h1 className="mr-2 bg-clip-text text-transparent bg-gradient-to-r from-blue-500 via-purple-500 to-red-500">
        ...
        <div className="lg:col-span-2 flex justify-center">
          <hr className="mt-5 border-gray-700 w-19/20 border-t-2 border-dashed" />
        </div>
        <div className="flex flex-col justify-center">
          <div
            id="line2"
            className="mb-2 text-2xl font-bold flex items-baseline"
          >
            <h1 className="mr-2 bg-clip-text text-transparent bg-gradient-to-r from-blue-300  to-yellow-300">
        ...
        <div className="flex flex-col justify-center">
          <div
            ...
            className="mb-2 text-2xl font-bold flex items-baseline"
          >
            <h1 className="mr-2 bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 via-blue-500  to-green-300">
        ...
        <div className="flex flex-col justify-center">
          <div
            ...
            className="mb-2 text-2xl font-bold flex items-baseline"
          >
            <h1 className="mr-2 bg-clip-text text-transparent bg-gradient-to-r from-red-500  to-blue-500">
              Cybersecurity
            </h1>
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="w-full grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 text-xl font-bold mb-3 text-center">
          <div className={AboutStyles.cardStyle}>
            <div>
              <h1 className="bg-clip-text text-transparent bg-gradient-to-r from-green-500 to-blue-500">
                Forensics
              </h1>
            </div>
          </div>
          <div className={AboutStyles.cardStyle}>
            <div>
              <h1 className="bg-clip-text text-transparent bg-gradient-to-r from-yellow-100 to-red-700 text-lg">
                Reverse Engineering
              </h1>
            </div>
          </div>
        ...
        <div className="flex flex-col justify-center">
          <div
            ...
            className="mb-2 text-2xl font-bold flex items-baseline"
          >
            <h1 className="mr-2 bg-clip-text text-transparent bg-gradient-to-r from-red-500  to-yellow-500">
              Misc.
            </h1>
            <svg
              xmlns="http://www.w3.org/2000/svg"
